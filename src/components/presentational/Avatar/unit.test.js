...
describe('Presentational Components', () => {
  describe('Avatar', () => {
    it('should renders without crashing', () => {
      ...
      ReactDOM.render(<Avatar name={'Carlos Lenon'} photoUrl={''} profEmail={''} codeEmail={''} showInfo={true} info={''} />, div);
  ...
  describe('Props', () => {
    ...
    it('name, photoUrl, profEmail and codeEmail shoul be a string type', () => {        
      const component = <Avatar name={'Carlos Lenon'} photoUrl={''} profEmail={''} codeEmail={''} showInfo={true} info={''} />;
